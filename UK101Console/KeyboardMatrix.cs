    ...
    public class KeyboardMatrix
    {
        ...
        */
        ...
        public KeyboardMatrix()
        {
            ...
            //_normal.Add(ConsoleKey.Oem1, new Key(ConsoleKey.Oem1, 1, 3, false));          // :
            _normal.Add(ConsoleKey.OemMinus, new Key(ConsoleKey.OemMinus, 1, 4, false));    // -
            _normal.Add(ConsoleKey.Delete, new Key(ConsoleKey.Delete, 1, 5, false));        // RUB OUT
            ...
            //_normal.Add(ConsoleKey.Oem3, new Key(ConsoleKey.oem3, 2, 3, false));            // ^
            ...
            _normal.Add(ConsoleKey.Spacebar, new Key(ConsoleKey.Spacebar, 6, 3, false));    // space
            ...
            _normal.Add(ConsoleKey.Oem4, new Key(ConsoleKey.Oem4, 4, 6, true));             // [
            ...
            _normal.Add(ConsoleKey.Backspace, new Key(ConsoleKey.Backspace, 1, 5, false));  // RUB OUT
            ...
            _shift.Add(ConsoleKey.Delete, new Key(ConsoleKey.Delete, 1, 5, false));             // RUB OUT
            ...
            _shift.Add(ConsoleKey.Spacebar, new Key(ConsoleKey.Spacebar, 6, 3, false));         // space
            _shift.Add(ConsoleKey.Oem2, new Key(ConsoleKey.Oem2, 6, 4, true));                  // ?
            ...
            // 0 - Nothing
            _shift.Add(ConsoleKey.Clear, new Key(ConsoleKey.Clear, 7, 1, false));  // CTRL
            // 2 - Nothing
            // 3 - Nothing
            // 4 - Nothing
            //_normal.Add(Keys.LShiftKey, new Key(Keys.LShiftKey, 7, 5, false));    // Left SHIFT
            //_normal.Add(Keys.RShiftKey, new Key(Keys.RShiftKey, 7, 6, false));    // Right SHIFT
            _shift.Add(ConsoleKey.Pause, new Key(ConsoleKey.Pause, 7, 5, false));    // Left SHIFT
            ...
            _shift.Add(ConsoleKey.Oem8, new Key(ConsoleKey.Oem8, 4, 5, true));                  // 
