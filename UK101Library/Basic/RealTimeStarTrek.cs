namespace UK101Library
{
	...
	{
		public string[] RealTimeStarTrek = new string[] {
			"",
			"",
			" 5 GS=655",
			" 10 DEFFNR(R)=INT(((T/1000+RND(1))-INT(T/1000+RND(0)))*R)",
			" 20 PRINTCHR$(12);:GOSUB8000:GOTO1000",
			...
			" 1200 PRINTCHR$(12);:PRINT\"  TIME  ENERGY SHIELDS KLINGONS TORPEDOES\"",
			" 1210 PRINT:PRINT\"  POWER PLANT  WARP DRIVE  IMPULSE DRIVE\"",
			" 1220 PRINT:PRINT\"  BATTLE STATUS:\":PRINT",
			" 1230 FORI=0TO9:PRINT\"  \";:FORJ=0TO9",
			" 1240 PRINTMID$(S$,S(J,I)+1,1);\" \";:NEXTJ",
			...
			" 2295 POKEPS+E3*2+E4*64,69:NEXT",
			...
			" 2340 GOSUB50:PK=PS+K(1,I)*2+K(2,I)*64:POKEPK,187",
			...
			" 2605 IFTF=0THEN2700",
			" 2610 PT=PS+TX*2+TY*64:IFPEEK(PT)<>69THENPOKEPT,213",
			" 2620 TX=TX+D(0,TF):TY=TY+D(1,TF)",
			" 2630 IFTX<0ORTX>9ORTY<0ORTY>9THENTF=0:GOTO2700",
			" 2640 PT=PS+TX*2+TY*64:IFPEEK(PT)=213THEN2690",
			...
			" 2844 E3=INT(E5-F1*10):E4=INT(E6-F2*10)",
			" 2845 GOTO2780",
			" 2850 IFL$<>\"T\"THEN3000",
			...
			" 7000 S(E3,E4)=4:FORA=-1TO1:FORB=-1TO1:X1=TX+A:Y1=TY+B",
			" 7010 IFX1<0ORX1>9ORY1<0ORY1>9THEN7100",
			" 7020 IFS(X1,Y1)=4THENDR=1",
			" 7030 IFS(X1,Y1)<>2THEN7060",
			" 7035 FORII=0TO4:IFK(0,II)<=0THEN7050",
			" 7040 IFK(1,II)=X1ANDK(2,II)=Y1THENK(0,II)=0",
			" 7050 NEXT:NK=NK-1:K=K-1",
			" 7060 H=PS+X1*2+Y1*64:POKEH,161:POKEH+1,161:POKEH-1,161",
			" 7100 NEXTB,A",
			" 7105 FORI=1TO1000:NEXT:IFDR=1THEN7500",
			" 7110 FORA=-1TO1:FORB=-1TO1:X1=TX+A:Y1=TY+B",
			" 7120 IFX1<0ORX1>9ORY1<0ORY1>9THEN7200",
			" 7130 H=PS+X1*2+Y1*64:S(X1,Y1)=0",
			" 7140 POKEH,213:POKEH+1,32:POKEH-1,32",
			" 7200 NEXTB,A:GOTO2000",
			" 7500 GOSUB61000:PRINT:PRINT\"YOU ARE ENGULFED IN YOUR OWN FIREBALL!\"",
			" 7510 PRINT\"TRIGGER HAPPY FOOL!!\":END",
			" 8000 PRINT:PRINT\" REAL-TIME STARTREK!\"",
			" 8002 PRINT\" -------------------\":PRINT",
			" 8005 FORI=0TO99:POKEGS+I,0:NEXT",
			" 8010 DIMD(1,8),S(9,9),K(2,4),P(2),D$(5)",
			" 8020 S$=CHR$(213)+\"*KBE\"",
			" 8040 K=40+FNR(10):FORI=1TOK:X=FNR(10):T=T+1:Y=FNR(10)",
			" 8050 POKEGS+X+Y*10,(PEEK(GS+X+Y*10)+10):NEXT",
			" 8060 B=2+FNR(4):FORI=1TOB:X=FNR(10):T=T+1:Y=FNR(10)",
			" 8070 POKEGS+X+Y*10,(PEEK(GS+X+Y*10)+1):T=T+1:NEXT",
			" 8080 E1=FNR(10):E2=FNR(10):E3=FNR(10):E4=FNR(10)",
			" 8100 T=4800:GOSUB9000:GOSUB60000",
			" 8105 GOSUB61000",
			" 8107 PRINT\"THERE ARE\";K;\"KLINGONS\"",
			" 8110 D$(0)=\"8 1 2\":D$(1)=\"7 E 3\":D$(2)=\"6 5 4\"",
			" 8115 D$(3)=\"u\":D$(4)=\"w\":D$(5)=\"y\"",
			" 8120 PRINT\"YOU HAVE\";T;\"STARDATES\"",
			" 8122 PRINT\"AND\";B;\"STARBASES\"",
			" 8128 PRINT\"YOU ARE IN SECTOR\";E1;E2:PRINT\" GOOD LUCK!\":PRINT",
			" 8132 PRINT\"(PRESS SPACE TO START)\":POKE530,1:POKE57088,253",
			" 8150 IFPEEK(57088)=255THEN8150",
			" 8152 D(0,2)=1:D(0,6)=-1:D(0,7)=-1:D(0,8)=-1",
			" 8153 D(1,5)=1:D(1,6)=1",
			...
			" 9410 IFS(E3-1-(E3<1),E4)=3THENGOSUB9500",
			" 9420 IFS(E3,E4-1-(E4<1))=3THENGOSUB9500",
			" 9430 IFS(E3+1+(E3>=9),E4)=3THENGOTO9500",
			" 9440 IFS(E3,E4+1+(E4>=9))=3THENGOTO9500",
			" 9441 IFS(E3,E4+1+(E4>=9))=3THENGOTO9500",
			" 9460 RETURN",
			...
			" 9530 RETURN",
			" 10000 PRINT:PRINT\"YOU ARE OUT OF TIME!\"",
			" 10010 PRINT\"THE KLINGONS PERFECT THEIR SECRET WEAPON\"",
			" 10020 PRINT\"AND TAKE OVER THE GALAXY!\":END",
			...
			" 60032 DATA79,0,85,0,92,0,100,0,109,0,207,0,220,0,232,0,29,1,84,1",
